package com.morewen.projectcommon.aspectj;


import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.support.spring.PropertyPreFilters;
import com.morewen.projectcommon.anno.Log;
import com.morewen.projectcommon.utils.StringUtils;
...
public class LogAspect
{
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            log.info("[{}],请求类:{},请求方法:{},请求参数:{},执行时间{}ms",model, className, methodName, params, runTime);
            if (!Objects.isNull(e)) {
